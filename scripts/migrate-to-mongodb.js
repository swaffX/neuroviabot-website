...
const GuildSettings = require('../bot/src/models/GuildSettings');

// Database paths
const DB_PATH = path.join(__dirname, '../bot/data/database.json');
const BACKUP_PATH = path.join(__dirname, '../bot/data/database_backup_before_migration.json');
