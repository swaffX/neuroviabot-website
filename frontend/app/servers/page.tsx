...
export default function ServersPage() {
  ...
  const getGuildIcon = (guild: Guild) => {
    if (guild.icon) {
      ...
      return getDiscordGuildIconUrl(guild.id, guild.icon, 128);
    }
    return null;
  };
          ...
          >
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-3 rounded-xl font-semibold transition-all ${filterBotPresent === null
              ...
              <button
                ...
                className={`px-4 py-3 rounded-xl font-semibold transition-all ${filterBotPresent === true
              ...
              <button
                ...
                className={`px-4 py-3 rounded-xl font-semibold transition-all ${filterBotPresent === false
